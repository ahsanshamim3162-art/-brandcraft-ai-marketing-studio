        ...
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <Link
              ...
              data-testid="link-topbar-new-campaign"
            >
              <Plus size={16} />
              New campaign
            </Link>
    ...
    <div className="page page-overview">
      <div className="page-heading heading-with-action">
        ...
        <Link
          ...
          data-testid="link-start-campaign"
        >
      ...
      <section className="section-block">
        ...
        {isLoading ? (
          <LoadingRow label="Loading your campaign workspace" />
        ) : campaigns?.length ? (
...
function TextAreaField({
  ...
  return (
    <label
      className={`field field-full ${error ? "field-error" : ""}`}
      data-testid={`field-${name}`}
    >
      <span className="field-label">
        {label}
...
function GeneratorPage() {
  ...
  const stages = [
    ...
    "Finding the audience tension",
    "Developing the campaign idea",
    "Building the activation plan",
  ...
  const validate = () => {
    const required: (keyof CampaignBrief)[] = [
      "brandName",
      "industry",
      "product",
      "targetAudience",
    ...
    const nextErrors: Partial<
      Record<keyof CampaignBrief, string>
    > = {};
    ...
    if (!brief.budgetCurrency.trim()) {
      nextErrors.budgetCurrency = "Choose a currency.";
    }
  ...
  const saveCampaign = () => {
    ...
    const onSuccess = (campaign: Campaign) => {
      ...
      setNotice({
        type: "success",
        text: savedId
          ? "Campaign updated in your library."
...
${strategy.strategicRationale}`;
    ...
    try {
      ...
      setNotice({
        type: "error",
        text: "Copy is unavailable in this browser. Select the strategy text to copy it manually.",
      });
    }
  };
  ...
  if (loadingEdit) {
    return (
      <div className="page centered-state">
        <LoadingRow label="Opening campaign brief" />
      </div>
    );
  }
      ...
      {showForm && (
        <section className="brief-layout">
          <div className="brief-intro">
            ...
            <p>
              Specific context creates a sharper strategy. Tell us what
              matters about the brand, the market, and the moment.
            </p>

            <div className="brief-aside">
              <div className="aside-line">
                <Check size={14} />
                <span>Structured for real campaign planning</span>
              </div>

              <div className="aside-line">
                <Check size={14} />
                <span>Recommendations grounded in your inputs</span>
              </div>

              <div className="aside-line">
                <Check size={14} />
                <span>Editable, saveable, and ready to share</span>
              </div>
            </div>
          </div>
          ...
          <div className="form-card">
            <div className="form-section-heading">
              <div>
                ...
                <p>
                  Fields marked with <em>*</em> are required.
                </p>
              </div>

              <span className="form-progress">1 of 1</span>
            </div>
            ...
            <div className="form-grid">
              ...
              <Field
                ...
                onChange={(value) =>
                  updateBrief("targetAudience", value)
                }
                placeholder="Who should care most?"
              ...
              <Field
                label="Primary marketing challenge"
                name="marketingChallenge"
                value={brief.marketingChallenge}
                onChange={(value) =>
                  updateBrief("marketingChallenge", value)
                }
              ...
              <div className="budget-field">
                ...
                <div className="budget-input">
                  <select
                    ...
                    data-testid="select-budgetCurrency"
                  >
                  ...
                  <input
                    ...
                    placeholder="50,000"
                    data-testid="input-budgetAmount"
                  />
                </div>
              ...
              <Field
                ...
                onChange={(value) =>
                  updateBrief("brandPersonality", value)
                }
              ...
              <Field
                ...
                onChange={(value) =>
                  updateBrief("differentiation", value)
                }
                placeholder="What makes this brand different from alternatives?"
              ...
              <TextAreaField
                ...
                placeholder="What is making this campaign necessary right now?"
            ...
            <div className="form-actions">
              <span className="form-footnote">
                <Sparkles size={14} />
                Your strategy is generated from this brief.
              </span>
...
function GenerationProgress({
  ...
  return (
    <section
      ...
      data-testid="status-generation-progress"
    >
      ...
      <div className="processing-copy">
        <span className="kicker">BrandCraft is working</span>
          ...
          {stages.map((item, index) => (
            <div
              className={`stage-item ${
                index < stage ? "stage-done" : ""
              } ${
                index === stage ? "stage-active" : ""
              }`}
              key={item}
            >
              {index < stage ? (
    ...
    <div className="strategy-workspace">
      <div className="strategy-topbar">
        ...
        <div className="strategy-actions">
          ...
          <button
            className="button button-secondary button-small"
            onClick={onCopy}
            data-testid="button-copy-campaign"
          >
            {copyState ? (
              <Check size={15} />
            ) : (
      ...
      <div className="strategy-meta-row">
        ...
        <span>
          ...
          {brief.budgetAmount.toLocaleString()} planning input
        </span>
      </div>
      ...
      <div className="strategy-grid">
        ...
        >
          ...
          <div className="message-block">
            ...
            <strong>{strategy.keyMessage}</strong>
          </div>
        </StrategyCard>
        ...
        <CreativeCard
          direction={strategy.creativeDirection}
        />
      ...
      <div className="strategy-footer">
        <span>
          <Sparkles size={14} />
          Strategic recommendations are generated from your brief
          and should be refined with live market learning.
        </span>
  ...
  return (
    ...
    >
      ...
      <div className="tag-list">
        {audience.characteristics.map((item) => (
...
function CreativeCard({
  ...
  direction: CampaignStrategy["creativeDirection"];
}) {
  return (
    <StrategyCard
...
function BudgetCard({
  ...
  brief: CampaignBrief;
  allocations: CampaignStrategy["budgetAllocation"];
}) {
  return (
    <StrategyCard
    ...
    >
      <p className="muted-copy">
        ...
        {brief.budgetCurrency}{" "}
        {brief.budgetAmount.toLocaleString()};
        not a projection of market performance.
      </p>
    ...
    >
      ...
      <div className="campaign-card-footer">
        ...
        <div className="card-actions">
          <Link
            href={`/campaign-generator?edit=${campaign.id}`}
            className="card-action-link"
            data-testid={`link-edit-campaign-${campaign.id}`}
          >
            Edit
          </Link>
          ...
          {onDelete && (
            <button
              className="card-action-link card-action-danger"
...
function LibraryPage() {
  ...
  const filtered = useMemo(
    () =>
      campaigns
        ?.filter((campaign) =>
          `${campaign.name} ${campaign.brandName} ${campaign.industry} ${campaign.objective}`
            .toLowerCase()
  ...
  const deleteCampaign = (id: string) => {
    if (
      !window.confirm(
        "Delete this campaign from your library?",
      )
    ) {
      return;
    }
    ...
    remove.mutate(
      { id },
      {
        onSuccess: () => {
          ...
          setNotice(
            "Campaign deleted from your library.",
          );
        },
        ...
        onError: (error) =>
          setNotice(
            getErrorMessage(
              error,
              "We couldn't delete that campaign.",
            ),
          ),
      },
    );
    ...
    <div className="page page-library">
      <div className="page-heading heading-with-action">
        ...
        <Link
          href="/campaign-generator"
          className="button button-primary"
          data-testid="link-library-new-campaign"
        >
          <Plus size={17} />
          New campaign
        </Link>
...
function CampaignDetailPage() {
  ...
  if (isLoading) {
    return (
      <div className="page centered-state">
        <LoadingRow label="Opening campaign strategy" />
      </div>
    );
  }
      ...
      <div className="page centered-state">
        <div className="error-state">
          ...
          <Link
            href="/campaigns"
            className="button button-secondary"
            data-testid="link-detail-back-library"
          >
            <ArrowLeft size={16} />
            Back to library
          </Link>
  ...
  return (
    <div className="page page-detail">
      ...
      <StrategyView
        ...
        onEdit={() =>
          setLocation(
            `/campaign-generator?edit=${campaign.id}`,
          )
        }
        onRegenerate={() =>
          setLocation(
  ...
  return (
    ...
    >
      ...
      <Link
        href="/campaign-generator"
        className="button button-primary"
        data-testid="link-empty-create-campaign"
      >
